...
INSERT INTO projects (title, thumbnail_path, description, display_order) VALUES
     ('High-Performance Developer Portfolio', '/thumb1.jpg', 'Engineered a custom, responsive portfolio application utilizing Server-Side Rendering (SSR) for optimal SEO and a 100/100 Lighthouse performance score. Implemented automated CI/CD deployment pipelines.', 1),
     ('Predictive Plastic Footprint Analysis (Microsoft AI Grant)', '/thumb2.jpg', 'Award-winning statistical analysis project mapping 10 years of land-use plastic pollution in India. Built predictive machine learning models hosted on Azure Virtual Machines.', 2),
     ('GistGator: AI Meeting Summarizer', '/thumb3.jpg', 'Developed an end-to-end NLP pipeline that ingests audio/video streams to generate automated meeting transcripts and abstractive summaries. Packaged as an interactive Chrome extension.', 3);
